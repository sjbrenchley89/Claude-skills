...
### Model Descriptions
- **Claude Opus 4.8** — Latest and most capable Claude model. Highly autonomous, strong on long-horizon agentic work, knowledge work, vision, and memory. Adaptive thinking only. 1M context window.
- **Claude Opus 4.7** — Highly autonomous, strong on long-horizon agentic work, knowledge work, vision, and memory. Adaptive thinking only; sampling parameters and `budget_tokens` are removed. 1M context window at standard API pricing (no long-context premium) — see `shared/model-migration.md` → Migrating to Opus 4.7 for breaking changes.
